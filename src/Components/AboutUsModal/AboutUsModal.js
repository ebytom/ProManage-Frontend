  ...
  return (
    ...
    >
      <div className="mt-4 p-2" style={{ textAlign: "justify" }}>
        Welcome to Project Management Tools, your go-to solution for hassle-free warranty
        management! Our mission is to simplify the way you organize and track
        your Projects by providing a secure, user-friendly platform. We
        believe that staying on top of your projrcts shouldn’t be complicated,
